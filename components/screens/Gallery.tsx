...
const Gallery = () => {
  ...
  return (
    <Container innerPadding>
      ...
      <div className="mt-8 mb-4 grid grid-cols-4 gap-5 md:grid-cols-2 md:grid-rows-4">
        {photos.map((url) => (
          <img
            className="opacity-90 rounded-lg w-full h-full max-h-50 object-cover block transition-transform duration-300 hover:scale-110 hover:opacity-100 hover:shadow-lg"
            alt="Gallery Image"
            src={url}
            key={url}
          />
